...
fn get_default_app_indicator() -> Option<AppIndicator> {
    ...
    let mut appindicator = AppIndicator::new("Remotely", icon_path.to_str().unwrap_or("rustdesk"));
    appindicator.set_label("Remotely", "A remote control software.");
